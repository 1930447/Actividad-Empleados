			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Modulo</span> - Listado de Tutorias</h4>
			...
			<div class="content">
				...
				<div class="card">
					...
					<table class="table datatable-show-all">
						...
						<tbody>
								<td>421</td>
								<td>Frederick Richard Nickson Stalon</td>
								<td>23/10/2019</td>
								<td>Falta de puntualidad en las clases</td>
							</tbody>
						<tbody>
								<td>123</td>
								<td>Carlos Selvera Crepusculo</td>
								<td>12/12/2019</td>
								<td>Recursamientos</td>
							</tbody>
						<tbody>
								<td>166</td>
								<td>Citlalli Yoalli Hernandez De la Cruz</td>
								<td>25/10/2019</td>
								<td>Inasistencias</td>
							</tbody>
