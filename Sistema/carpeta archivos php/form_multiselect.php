			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Modulo</span> -Maestros</h4>
			...
			<div class="content">
				...
				<div class="card">
					...
					<table class="table datatable-show-all">
						...
						<tbody>
								<td>121</td>
								<td>Musolini Chaves Sepeda</td>
								<td>Programacion</td>
							</tbody>
						<tbody>
								<td>127</td>
								<td>Juan Francisco Ochoa Fernandez</td>
								<td>Mecatronica</td>
							</tbody>
						<tbody>
								<td>212</td>
								<td>Edwar Frederick Wilson Kenway</td>
