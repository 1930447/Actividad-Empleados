			...
			<div class="page-header page-header-light">
				<div class="page-header-content header-elements-md-inline">
					<div class="page-title d-flex">
						<h4><i class="icon-arrow-left52 mr-2"></i> <span class="font-weight-semibold">Modulo</span> - Agregar tutorias</h4>
					...
					<div class="col-md-4">
			            ...
			            <div class="card">
							<div class="card-header header-elements-inline">
				                <h6 class="card-title">Agregar Nueva Tutoria</h6>
			                ...
			                <div class="card-body">
			                	<form action="#">
									...
									<div class="form-group">
										<label>Fecha para la sesion:</label>
										<textarea rows="3" cols="3" class="form-control" placeholder="Enter your message here"></textarea>
									</div>

									<div class="form-group">
										<label>Hora de la sesion :</label>
										<textarea rows="3" cols="3" class="form-control" placeholder="Enter your message here"></textarea>
									</div>
									...
									<div class="d-flex justify-content-start align-items-center">
										...
										<button type="submit" class="btn bg-blue ml-3">Agregar <i class="icon-paperplane ml-2"></i></button>
									</div>
								</form>
							</div>
		                </div>
