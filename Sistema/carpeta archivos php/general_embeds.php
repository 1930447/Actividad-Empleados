					...
					<ul class="nav nav-sidebar" data-nav-type="accordion">
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Form components">
								...
								<li class="nav-item"><a href="form_actions.php" class="nav-link active">Tabla</a></li>
								<li class="nav-item"><a href="form_actions.php" class="nav-link active">Registrar</a></li>
								<li class="nav-item"><a href="form_actions.php" class="nav-link active">Editar</a></li>
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Extensions">
								<li class="nav-item"><a href="extension_blockui.php" class="nav-link active">Tabla de empresas</a></li>
							</ul>
						</li>
						...
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							...
							<ul class="nav nav-group-sub" data-submenu-title="Data tables">
								<li class="nav-item"><a href="datatable_basic.php" class="nav-link active">Tabla</a></li>

								<li class="nav-item"><a href="datatable_basic.php" class="nav-link">Registrar</a></li>

								<li class="nav-item"><a href="datatable_basic.php" class="nav-link">Editar</a></li>
								<li class="nav-item"><a href="datatable_styling.php" class="nav-link active">Vacaciones</a></li>
						...
						<!-- Page kits -->
						<li class="nav-item-header"><div class="text-uppercase font-size-xs line-height-xs">Transporte </div> <i class="icon-menu" title="Page kits"></i></li>
						<li class="nav-item nav-item-submenu nav-item-expanded nav-item-open">
							<a href="#" class="nav-link"><i class="icon-grid6"></i> <span>Pago de transporte</span></a>
				...
				<div class="card mb-4">
					...
					<table class="table datatable-basic">
						<thead>
							...
							<tbody>
								<tr>
								<td>Carlos Monlina</td>
								<td>1930449</td>
								<td>12 y 13 coahuila</td>
								<td>13</td>
								<td>matutina<td/>
								<td>Ninguna</td>
									<td><div class="d-flex justify-content-start align-items-center">
										<button type="submit" class="btn btn-light">Borrar</button></td>
																		...
																		<td><div class="d-flex justify-content-start align-items-center">
										<button type="submit" class="btn btn-light">Registrar</button></td>							
							</tr>
						</tbody>
													<tbody>
								<tr>
								<td>Sofia Monarrez</td>
								<td>1930456</td>
								<td>12 y 13 coahuila</td>
								<td>13</td>
								<td>matutina<td/>
